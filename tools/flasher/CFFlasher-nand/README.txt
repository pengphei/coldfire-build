...
Note: If the LPT debugger is used, Please backup the BDMProtocol\PE_USB_ML.dll and then rename the BDMProtocol\PE_LPT.dll file to BDMProtocol\PE_USB_ML.dll.
