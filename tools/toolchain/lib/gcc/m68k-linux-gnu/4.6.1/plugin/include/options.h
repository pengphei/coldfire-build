...
#ifndef GENERATOR_FILE
  int x_VAR_m5200;
#define x_VAR_m5200 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m5206e;
#define x_VAR_m5206e do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m528x;
#define x_VAR_m528x do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m5307;
#define x_VAR_m5307 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m5407;
#define x_VAR_m5407 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68000;
#define x_VAR_m68000 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68010;
#define x_VAR_m68010 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68020;
#define x_VAR_m68020 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68020_40;
...
#ifndef GENERATOR_FILE
  int x_VAR_m68030;
#define x_VAR_m68030 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68040;
#define x_VAR_m68040 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68060;
#define x_VAR_m68060 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68302;
#define x_VAR_m68302 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68332;
#define x_VAR_m68332 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_m68851;
...
#ifndef GENERATOR_FILE
  int x_VAR_mc68000;
#define x_VAR_mc68000 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mc68020;
#define x_VAR_mc68020 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mcfv4e;
#define x_VAR_mcfv4e do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mcpu32;
#define x_VAR_mcpu32 do_not_use
#endif
#ifndef GENERATOR_FILE
...
#ifndef GENERATOR_FILE
  int x_VAR_mieee_fp;
#define x_VAR_mieee_fp do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_HARD_FLOAT (1 << 0)
#define MASK_ALIGN_INT (1 << 1)
#define OPTION_MASK_ANDROID (1 << 0)
#define MASK_BITFIELD (1 << 2)
#define MASK_CF_HWDIV (1 << 3)
#define MASK_ID_SHARED_LIBRARY (1 << 4)
#define MASK_PCREL (1 << 5)
#define MASK_RTD (1 << 6)
#define MASK_SEP_DATA (1 << 7)
#define MASK_SHORT (1 << 8)
#define MASK_STRICT_ALIGNMENT (1 << 9)
#define MASK_XGOT (1 << 10)
#define MASK_XTLS (1 << 11)
...
enum opt_code
{
  ...
  OPT_m5200 = 955,                           /* -m5200 */
  OPT_m5206e = 956,                          /* -m5206e */
  OPT_m528x = 957,                           /* -m528x */
  OPT_m5307 = 958,                           /* -m5307 */
  OPT_m5407 = 959,                           /* -m5407 */
  OPT_m68000 = 960,                          /* -m68000 */
  OPT_m68010 = 961,                          /* -m68010 */
  OPT_m68020 = 962,                          /* -m68020 */
  OPT_m68020_40 = 963,                       /* -m68020-40 */
  OPT_m68020_60 = 964,                       /* -m68020-60 */
  OPT_m68030 = 965,                          /* -m68030 */
  OPT_m68040 = 966,                          /* -m68040 */
  OPT_m68060 = 967,                          /* -m68060 */
  OPT_m68302 = 968,                          /* -m68302 */
  OPT_m68332 = 969,                          /* -m68332 */
  OPT_m68851 = 970,                          /* -m68851 */
  OPT_m68881 = 971,                          /* -m68881 */
  OPT_malign_int = 972,                      /* -malign-int */
  OPT_mandroid = 973,                        /* -mandroid */
  OPT_march_ = 974,                          /* -march= */
  OPT_mbionic = 975,                         /* -mbionic */
  OPT_mbitfield = 976,                       /* -mbitfield */
  OPT_mc68000 = 977,                         /* -mc68000 */
  OPT_mc68020 = 978,                         /* -mc68020 */
  OPT_mcfv4e = 979,                          /* -mcfv4e */
  OPT_mcpu32 = 980,                          /* -mcpu32 */
  OPT_mcpu_ = 981,                           /* -mcpu= */
  OPT_mdiv = 982,                            /* -mdiv */
  OPT_mfidoa = 983,                          /* -mfidoa */
  OPT_mglibc = 984,                          /* -mglibc */
  OPT_mhard_float = 985,                     /* -mhard-float */
  OPT_mid_shared_library = 986,              /* -mid-shared-library */
  OPT_mieee_fp = 987,                        /* -mieee-fp */
  OPT_mnobitfield = 988,                     /* -mnobitfield */
  OPT_mnortd = 989,                          /* -mnortd */
  OPT_mnoshort = 990,                        /* -mnoshort */
  OPT_mpcrel = 991,                          /* -mpcrel */
  OPT_mrtd = 992,                            /* -mrtd */
  OPT_msep_data = 993,                       /* -msep-data */
  OPT_mshared_library_id_ = 994,             /* -mshared-library-id= */
  OPT_mshort = 995,                          /* -mshort */
  OPT_msoft_float = 996,                     /* -msoft-float */
  OPT_mstrict_align = 997,                   /* -mstrict-align */
  OPT_mtune_ = 998,                          /* -mtune= */
  OPT_muclibc = 999,                         /* -muclibc */
  OPT_mxgot = 1000,                          /* -mxgot */
  OPT_mxtls = 1001,                          /* -mxtls */
  OPT_n = 1002,                              /* -n */
  OPT_no_canonical_prefixes = 1003,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1004,              /* -no-integrated-cpp */
  OPT_nocpp = 1005,                          /* -nocpp */
  OPT_nodefaultlibs = 1006,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1007,                   /* -nostartfiles */
  OPT_nostdinc = 1008,                       /* -nostdinc */
  OPT_nostdinc__ = 1009,                     /* -nostdinc++ */
  OPT_nostdlib = 1010,                       /* -nostdlib */
  OPT_o = 1011,                              /* -o */
  OPT_p = 1012,                              /* -p */
  OPT_pass_exit_codes = 1013,                /* -pass-exit-codes */
  OPT_pedantic = 1014,                       /* -pedantic */
  OPT_pedantic_errors = 1015,                /* -pedantic-errors */
  OPT_pg = 1016,                             /* -pg */
  OPT_pie = 1017,                            /* -pie */
  OPT_pipe = 1018,                           /* -pipe */
  OPT_posix = 1019,                          /* -posix */
  OPT_print_file_name_ = 1020,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1021,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1022,          /* -print-multi-directory */
  OPT_print_multi_lib = 1023,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1024,       /* -print-multi-os-directory */
  ...
  OPT_std_c__98 = 1052,                      /* -std=c++98 */
  OPT_std_c1x = 1053,                        /* -std=c1x */
  /* OPT_std_c89 = 1054, */                  /* -std=c89 */
  OPT_std_c90 = 1055,                        /* -std=c90 */
  OPT_std_c99 = 1056,                        /* -std=c99 */
  /* OPT_std_c9x = 1057, */                  /* -std=c9x */
  OPT_std_f2003 = 1058,                      /* -std=f2003 */
  OPT_std_f2008 = 1059,                      /* -std=f2008 */
  OPT_std_f95 = 1060,                        /* -std=f95 */
  OPT_std_gnu = 1061,                        /* -std=gnu */
  OPT_std_gnu__0x = 1062,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1063,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1064,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1065, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1066,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1067,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1068, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1069, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1070,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1071, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1072, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1073,                     /* -std=legacy */
  OPT_symbolic = 1074,                       /* -symbolic */
  OPT_t = 1075,                              /* -t */
  OPT_time = 1076,                           /* -time */
  OPT_time_ = 1077,                          /* -time= */
  OPT_tno_android_cc = 1078,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1079,                 /* -tno-android-ld */
  OPT_traditional = 1080,                    /* -traditional */
  OPT_traditional_cpp = 1081,                /* -traditional-cpp */
  OPT_trigraphs = 1082,                      /* -trigraphs */
  OPT_u = 1083,                              /* -u */
  OPT_undef = 1084,                          /* -undef */
  OPT_v = 1085,                              /* -v */
  OPT_version = 1086,                        /* -version */
  OPT_w = 1087,                              /* -w */
  OPT_wrapper = 1088,                        /* -wrapper */
  OPT_x = 1089,                              /* -x */
  OPT_z = 1090,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
